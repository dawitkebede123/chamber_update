import 'dart:async';
// import 'dart:ffi';
import 'package:chamber_of_commerce/pages/admin/editForm.dart';
...
class SearchFieldAdmin extends StatefulWidget {

  //  final bool filter;
  const SearchFieldAdmin({Key? key});

  @override
  State<SearchFieldAdmin> createState() => _SearchFieldAdminState();
}

class _SearchFieldAdminState extends State<SearchFieldAdmin> {
...
for (final element in data) {
  ...
  Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => EditForm(data: company),
              ),
            );
            }
            else{
