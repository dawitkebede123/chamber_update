...
class Hotel_listing extends StatefulWidget {
  ...
  @override
  State<Hotel_listing> createState() => _Hotel_listingState();
}

class _Hotel_listingState extends State<Hotel_listing> {
  ...
  void initState() {
    ...
    .orderByChild('Sector')
             ...
             .startAt("HOTEL AND RESTAURANTS")
            .endAt("HOTEL AND RESTAURANTS" + '\uffff')
    .onValue
