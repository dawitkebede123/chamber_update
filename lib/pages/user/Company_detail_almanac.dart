...
import 'package:chamber_of_commerce/widgets/CompanyDescriptionAlmanac.dart';
...
class CompanyDetailAlmanac extends StatefulWidget {
      // int index= 2;
  final Map<dynamic, dynamic> data;

    const CompanyDetailAlmanac({super.key, required this.data});
 
  @override
  State<CompanyDetailAlmanac> createState() => CompanyState();
}

class CompanyState extends State<CompanyDetailAlmanac> {
  ...
  Widget build(BuildContext context) {
    ...
    shape: RoundedRectangleBorder(
     ...
     actions: [
      ...
      body: isAdv?CompanyDescriptionAlmanac(detail: widget.data): Padding(padding: EdgeInsets.all(10),
      child:  Container(
