...
class _Logo_Adv_List_almanac_offlineState extends State<Logo_Adv_List_almanac_offline> {
  ...
  List<Map<dynamic, dynamic>> uniqueBusinesses = [
   ...
   },  
   {
     ...
     "adv_video":"assets/video/Awash.gif",
   ...
   },
   {
     ...
     "adv_video":"assets/video/Dashen_Bank.gif",
   ...
   },
   {
     ...
     "adv_video":"assets/video/Hibret_Bank.gif",
   ...
   },
    {
     ...
     "adv_video":"assets/video/Oromia_Bank.gif",
   ...
   },
   {
     ...
     "adv_video":"assets/video/Tsedey_Bank.gif",
