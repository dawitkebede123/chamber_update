...
class ExpandedPanelFAQ extends StatefulWidget {
  final List<Map<String,dynamic>> data;
 bool clickable;
   ExpandedPanelFAQ({super.key,required this.data, this.clickable = false});

  @override
  State<ExpandedPanelFAQ> createState() => _ExpandedPanelState();
}

class _ExpandedPanelState extends State<ExpandedPanelFAQ> {
